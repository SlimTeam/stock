...
<div class="top-margin table-responsive">
  ...
  <?php } else { ?>
    <div class="col-sm-1">
      <b><?php echo html_escape($this->lang->line('header_picture')); ?></b>
    </div>
    <div class="col-sm-2">
      <b><?php echo html_escape($this->lang->line('header_status')); ?></b>
    </div>
    <div class="col-sm-5">
      <b><?php echo html_escape($this->lang->line('header_item_name')); ?></b>
    </div>
    <div class="col-sm-2">
      <b><?php echo html_escape($this->lang->line('header_stocking_place')); ?></b>
    </div>
    <div class="col-sm-2">
      <b><?php
